...
def main_generate_multifile_voice_conversion(args_dict):
    ...
    # Load mapping from JSON if provided
    if hasattr(args, 'mapping_json') and args.mapping_json:
        mapping = args.mapping_json
        # Convert mapping to list of (source, target) pairs
        source_target_pairs = [(src, tgt) for src, tgt in mapping.items()]
...
def load_model_task(args_dict):
    """Loads the models and returns them.  This function is only called once."""

    args = Args(args_dict)
    model, semantic_fn, f0_fn, vocoder_fn, campplus_model, mel_fn, mel_fn_args = load_models(args)

    return model, semantic_fn, f0_fn, vocoder_fn, campplus_model, mel_fn, mel_fn_args, args.f0_condition, args.auto_f0_adjust, args.semi_tone_shift, mel_fn_args['sampling_rate']


@torch.no_grad()
def voice_conversion_task(
    model,
    semantic_fn,
    f0_fn,
    vocoder_fn,
    ...
    """Performs voice conversion using the loaded models."""
...
# args_dict = {
#     "source": "D:\\Audio_Preprocessing\\text_to_speech\\emotion_voice_reference\\angry_4.wav",
#     "target": "D:\\Audio_Preprocessing\\seed-vc\\Honkai_SR_voice_cleaned\\MARCH_7TH_INTERACTIVE_VOICES (ENGLISH)\\MARCH_7TH_INTERACTIVE_VOICES (ENGLISH).wav",
#     "output": "D:\\Audio_Preprocessing\\seed-vc\\output_voice",
#     "diffusion_steps": 25,
#     "length_adjust": 1.0,
...
#     "auto_f0_adjust": True,
#     "semi_tone_shift": 0,
#     "checkpoint_path": "D:\\Audio_Preprocessing\\seed-vc-model\\DiT_seed_v2_uvit_whisper_base_f0_44k_bigvgan_pruned_ft_ema.pth",
#     "config_path": "D:\\Audio_Preprocessing\\seed-vc\\configs\\presets\\config_dit_mel_seed_uvit_whisper_base_f0_44k.yml",
#     "fp16": True
# }
